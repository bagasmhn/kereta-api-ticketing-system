...
exports.KursiService = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../prisma/prisma.service");
let KursiService = class KursiService {
    prisma;
    constructor(prisma) {
        this.prisma = prisma;
    }
    ...
    async findOne(id) {
        ...
        if (!kursi) {
            throw new common_1.NotFoundException('Kursi tidak ditemukan');
        }
        return kursi;
    }
    async update(id, dto) {
...
exports.KursiService = KursiService;
exports.KursiService = KursiService = __decorate([
